...
class Detector:
    ...
    def _add_box_predictions(self, feature_maps):
        ...
        with tf.name_scope('reshaping'):
            ...
            self.box_encodings = tf.concat(box_encodings, axis=1, name='loc_predict')
            self.class_predictions_with_background = tf.concat(class_predictions_with_background, axis=1, name='conf_predict')
